			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="box">
				<tr>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="title_info">
							...
							<tr>
								<td class="info_text">所在地区：<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&amp;ph=1&amp;myarea=<?=$ecms_gr[myarea]?>"><?=$ecms_gr[myarea]?></a>&nbsp;&nbsp;</td>
								<td align="right" class="info_text">时间：<?=date('Y年m月d日 H:i:s',$ecms_gr[newstime])?>&nbsp;&nbsp;【<a 
href="/e/member/fava/add/?classid=<?=$ecms_gr[classid]?>&amp;id=<?=$ecms_gr[id]?>">加入收藏夹</a>】【<a href="/e/public/report/?classid=<?=$ecms_gr[classid]?>&amp;id=<?=$ecms_gr[id]?>" target="_blank">举报</a>】【<a href="javascript:window.close()">关闭</a>】</td>
							</tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
                ...
                <td width="88%" bgcolor="#FFFFFF"><?=$ecms_gr[ismember]==1&&$ecms_gr[userid]?'<a href="'.$public_r[newsurl].'e/space/?userid='.$ecms_gr[userid].'" target=_blank>'.$ecms_gr[username].'</a>':$ecms_gr[username]?>&nbsp;(<a href="/e/member/msg/AddMsg/?enews=AddMsg&amp;re=1&amp;username=<?=$ecms_gr[username]?>" target="_blank">发送站内信息</a>)</td>
							</tr>
							<tr>
...
<input type="hidden" name="ecmsfrom" value="<?=$grtitleurl?>"></td>
	...
	<tr>
		<td width="33%"><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=东城区">东城区</a></td>
		<td width="33%"><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=西城区">西城区</a></td>
		<td width="33%"><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=通州区">通州区</a></td>
	</tr>
	<tr>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=崇文区">崇文区</a></td>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=宣武区">宣武区</a></td>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=大兴区">大兴区</a></td>
	</tr>
	<tr>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" /><a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=朝阳区">&nbsp;朝阳区</a></td>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=海淀区">海淀区</a></td>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=昌平区">昌平区</a></td>
	</tr>
	<tr>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=丰台区">丰台区</a></td>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=石景山区">石景山区</a></td>
		<td><img src="/e/data/images/msgnav.gif" width="5" height="5" />&nbsp;<a href="/e/action/ListInfo.php?classid=<?=$ecms_gr[classid]?>&ph=1&myarea=其它">其它</a></td>
	</tr>
</table></td>
				</tr>
			</table>
