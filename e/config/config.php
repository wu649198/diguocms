...
$ecms_config['db']['dbusername']='user_whwei';	//数据库用户名
$ecms_config['db']['dbpassword']='wu195614rotps';	//数据库密码
$ecms_config['db']['dbname']='leeter';	//数据库名
...
//后台安全设置
$ecms_config['esafe']['loginauth']='rzd58h6p';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['enloginauth']=0;	//登录认证码加密验证串有效时间,单位:秒(0为不启用加密)
$ecms_config['esafe']['ecookiernd']='NYrdwycDR4Rf6tHFYyWb18BKuHJVf9DAbzYy';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='pvppa';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='mfmft';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='jRAy74slzTz0WB1BvuelaY4fgacOi9sRJrt';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='72BtHT1VT5St96SbeYmbn1PPJj5HnpeHIu';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='XWnQ3jEJyu6W14Bo97VQVU1RUQ837SLHg';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='B3VH4XidqnyZmgU7ObGWnajcvu2QSLUt';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='hoGWSf8NU44QU4uKgcF9pHvfKjse7BR';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'3gN8Zrmdj6iese0NP6kjIUnfze07cRGR',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/news/\">新闻中心</a>&nbsp;|&nbsp;<a href=\"/download/\">下载中心</a>&nbsp;|&nbsp;<a href=\"/movie/\">影视频道</a>&nbsp;|&nbsp;<a href=\"/shop/\">网上商城</a>&nbsp;|&nbsp;<a href=\"/flash/\">FLASH频道</a>&nbsp;|&nbsp;<a href=\"/photo/\">图片频道</a>&nbsp;|&nbsp;<a href=\"/article/\">文章中心</a>&nbsp;|&nbsp;<a href=\"/info/\">分类信息</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'1W5zdUd2c8JzLqEvdV4W5Mj8hB5vA0nGcqeG',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'MzDckneDstQIG71P2Y7vS8l274vkYCiSMl3HuapElY',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
